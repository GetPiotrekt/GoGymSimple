  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                  ...
                  children: [
                    ...
                    Table(
                      ...
                      children: [
                        TableRow(
                          children: [
                            _buildTableHeader(t.calculator1RM_table_header_percentage, colorProvider),
                            _buildTableHeader(t.calculator1RM_table_header_reps, colorProvider),
                            _buildTableHeader(
                              _isPounds
                        ...
                        ...List.generate(10, (index) {
                          ...
                          int reps = [2, 4, 6, 8, 10, 12, 16, 20, 24, 30][index];
                          double weightKg = _oneRM * percentage / 100;
                          double weight = _isPounds ? convertKgToLbs(weightKg) : weightKg;

                          return TableRow(
                            children: [
                              _buildTableCell('$percentage%', colorProvider),
                              _buildTableCell('$reps', colorProvider),
                              _buildTableCell(weight.toStringAsFixed(1), colorProvider),
                            ],
                          );
                        }),
                      ],
                    ...
                    children: [
                      Expanded(
                        child: InputFormField(
                          labelText: _isPounds
                              ? '${t.calculator1RM_weightLabel} (lbs)'
                              : '${t.calculator1RM_weightLabel} (kg)',
                      ...
                      Expanded(
                        child: InputFormField(
                          labelText: t.calculator1RM_repsLabel,
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: Text(
          _isPounds ? ' lbs ' : ' kg ',
          style: TextStyle(color: colorProvider.secondary, fontWeight: FontWeight.bold),
        ),
      ),
    );
  }
